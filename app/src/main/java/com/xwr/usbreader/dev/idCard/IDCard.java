package com.xwr.usbreader.dev.idCard;
...
public class IDCard {
	private String name;
	private String sex;
	private String nation;//外国人代表是国籍或所在地代码
	private String birthday;
	private String address;
	private String idcardno;//外国人代表是永久居留证号码
	...
	private String signissuecount;
	private String idcardtype;
	////////////////外国人
	private String chineseName;//中文名字
	private String idcardVersion;//证件版本号
	private String applicationAgencyNo;//当次申请受理机关代码


	public byte SW1, SW2, SW3;
	public String strCommandPeroid, strDataPeroid;
	public int decodeResult;
	private static final String[] nations = { "解码错", // 00
			"汉", // 01
			"蒙古", // 02
			"回", // 03
			"藏", // 04
	...
	public String getNationName(String nation) throws UnsupportedEncodingException {
		// 叶庆伟测出民族有编码错误,加了一个抛出异常
		try {
			if("".equals(nation.trim()))return "";
	...
	public String getSignissuecount() {
		return signissuecount;
	}

	public void setSignissuecount(String signissuecount) {
		this.signissuecount = signissuecount;
	}
	...
	public String getApplicationAgencyNo() {
		return applicationAgencyNo;
	}

	public void setApplicationAgencyNo(String applicationAgencyNo) {
		this.applicationAgencyNo = applicationAgencyNo;
	}
}
